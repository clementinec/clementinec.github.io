...
<div class="table-container">
    ...
    <div class="text-cell">
        ...
        <div class="affiliation">Associate Head (Technology Transfer) and Associate Professor, Department of Architecture</div>
        <p>Prof. Dr. Kristof CROLLAis a licensed architect and tenured Associate Professor at the University of Hong Kong (<a href="https://www.arch.hku.hk/">HKU</a>), where he serves as Associate Head (Technology Transfer) of the Department of Architecture. He teaches in the Master of Architecture programme and directs both the <a href="https://www.basc.hku.hk/basc-design-plus/">BASc(Design+)</a> programme and the Building Simplexity Lab (<a href="https://bsl.hku.hk/">BSL</a>) research group. He also leads the architectural practice Laboratory for Explorative Architecture & Design Ltd. (<a href="http://www.l-e-a-d.pro/">LEAD</a>). Crolla previously worked with Zaha Hadid Architects and has been invited globally as a critic, lecturer, and tutor. His creative scholarly practice has received numerous awards for design, research, and teaching, including World Architecture Festival Awards in 2016 and 2024. He is internationally recognised for projects such as '<a href="https://l-e-a-d.pro/portfolio/zcb/">ZCB Bamboo Pavilion</a>', '<a href="https://l-e-a-d.pro/portfolio/yezo/">YEZO</a>', and '<a href="https://l-e-a-d.pro/portfolio/memutar/">MemutAR</a>'. Crolla completed his PhD at RMIT University in Melbourne and was appointed in 2019 as a Task Force Expert Member for Bamboo Construction by <a href="http://www.inbar.int/">INBAR</a>. He chaired the Organising Committee for the CAADRIA 2021 Hong Kong Conference (<a href="https://caadria2021.org/">caadria2021.org</a>).</p>
    </div>
</div>
```
...
<div class="table-container">
    ...
    <div class="text-cell">
        <h3>LEAD CO-CHAIR: Prof. Dr. Kam-Ming Mark TAM </h3>
        <div class="affiliation">Assistant Professor, Department of Architecture</div>
...
<div class="table-container">
    ...
    <div class="text-cell">
        ...
        <div class="affiliation">Lecturer, Department of Architecture</div>
        <p>Mr. Haotian Zhang is an architectural designer, media artist, and Lecturer at the University of Hong Kong. He holds degrees from Cooper Union and Tsinghua University. Zhang’s work focuses on realist digital media, investigating their aesthetics, technics, and politics in various mediums. At HKU, he initiated the Model Archive, an archive of scanned physical models from design studios. Zhang co-founded multi-disciplinary design studio FrankanLisa with Tianying Li. Their work has been exhibited internationally at venues including the Venice Architecture Biennale and the Bi-City Biennale of Urbanism/Architecture. He was the recipient of the Young Talent Award at UABB 2022.</p>
    </div>
</div>
```
...
<div class="table-container">
    ...
    <div class="text-cell">
        <h3>SCIENTIFIC PROGRAMME COMMITTEE CHAIR: Prof. Dr. Fan (Frank) Xue</h3>
        <div class="affiliation">Associate Head (Research) and Associate Professor, Department of Real Estate and Construction</div>
...
<div class="table-container">
    ...
    <div class="text-cell">
        <h3>SCIENTIFIC PROGRAMME COMMITTEE CO-CHAIR: Prof. Dr. Tan Tan</h3>
        <div class="affiliation">Assistant Professor, Department of Real Estate and Construction</div>
...
<div class="table-container">
    ...
    <div class="text-cell">
        <h3>SITE & EVENTS LEAD: Mr. Mono Tung</h3>
        <div class="affiliation">Assistant Lecturer, Department of Architecture</div>
...
<div class="table-container">
    ...
    <div class="text-cell">
        <h3>MARKETING LEAD: Mr. Kaiho Yu</h3>
        <div class="affiliation">Lecturer, Department of Architecture</div>
...
<div class="table-container">
    ...
    <div class="text-cell">
        <h3>OUTREACH LEAD: Mr. Jeff WIDJAJA</h3>
        <div class="affiliation">Assistant Lecturer, Department of Architecture</div>
...
<div class="table-container">
    <div class="image-cell">
        <img src="images/CL.png" alt="Ms. Candy LAU">
    </div>
    <div class="text-cell">
        <h3>ADMINISTRATION LEAD: Ms. Candy LAU</h3>
        <div class="affiliation">Executive Officer, Department of Architecture</div>
        <p>Candy Lau is an Executive Officer at the University of Hong Kong. With a unique background combining arts administration and public relations, Candy brings extensive insights in managing cultural events and collaborating closely with creative teams and artists. She holds a Master’s degree in Communication from Hong Kong Baptist University and a Bachelor’s in Arts, Event & Stage Management from The Hong Kong Academy for Performing Arts. Candy’s expertise in event coordination, stakeholder engagement, theatre production management and multimedia content development contribute to dynamic experiences that fosters innovation and global collaboration in the creative industry.</p>
    </div>
</div>
```
...
<div class="table-container">
    <div class="image-cell">
        <img src="images/AL.png" alt="Mr. Anthony C. W. LAM">
    </div>
    <div class="text-cell">
        <h3>GRAPHIC DESIGN LEAD: Mr. Anthony C. W. LAM</h3>
        <div class="affiliation">Graphic Designer, Department of Architecture</div>
        <p>Anthony Lam is a multidisciplinary designer based in Hong Kong, specializing in visual identity, branding, illustration and editorial design. He is now the graphic designer of Department of Architecture, The University of Hong Kong, contributing to the branding and visual communication matters of the department as well as the faculty. Prior to his role in HKU he also has worked in the global brand deisgn and consultancy Superunion (now Design Bridge and Partners), and Office for Metropolitan Architecture (OMA) Hong Kong office.</p>
    </div>
</div>
```

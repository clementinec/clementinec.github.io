...
<div class="table-container">
    ...
    <div class="text-cell">
        ...
        <p>Candy has been instrumental in enabling the conference logistics and has worked tirelessly to make sure the delivery of info is speedy and accurate across the board.</p>
    </div>
</div>
```

...
<div class="table-container">
    ...
    <div class="text-cell">
        ...
        <p>Anthony is affiliated with Department of Architecture as graphic designer and has done tremendous amount of work to make sure the graphics delivery of images for this conference.</p>
    </div>
</div>
```

...
<div class="table-container">
    ...
    <div class="text-cell">
        ...
        <p>Prof. Dr. Kristof CROLLA is a licensed architect and tenured Associate Professor at the University of Hong Kong ([HKU](https://www.arch.hku.hk/)), where he serves as Associate Head (Technology Transfer) of the Department of Architecture. He teaches in the Master of Architecture programme and directs both the [BASc(Design+)](https://www.basc.hku.hk/basc-design-plus/) programme and the Building Simplexity Lab ([BSL](https://bsl.hku.hk/)) research group. He also leads the architectural practice Laboratory for Explorative Architecture & Design Ltd. ([LEAD](http://www.l-e-a-d.pro/)). Crolla previously worked with Zaha Hadid Architects and has been invited globally as a critic, lecturer, and tutor. His creative scholarly practice has received numerous awards for design, research, and teaching, including World Architecture Festival Awards in 2016 and 2024. He is internationally recognised for projects such as '[ZCB Bamboo Pavilion](https://l-e-a-d.pro/portfolio/zcb/)', '[YEZO](https://l-e-a-d.pro/portfolio/yezo/)', and '[MemutAR](https://l-e-a-d.pro/portfolio/memutar/)'. Crolla completed his PhD at RMIT University in Melbourne and was appointed in 2019 as a Task Force Expert Member for Bamboo Construction by [INBAR](http://www.inbar.int/). He chaired the Organising Committee for the CAADRIA 2021 Hong Kong Conference ([caadria2021.org](https://caadria2021.org/)).
        </p>
    </div>
</div>
```
